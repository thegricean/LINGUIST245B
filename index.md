...
| 8 | **May 23** [code sheet](code_sheets/2_mixed_effects_linear_regression_withprompts.R) <br />  `Data analysis:` mixed effects linear regression | **May 25** [slides](slides/5_mixed_effects_logistic_regression.pdf) <br /> `Data analysis:` (mixed effects) logistic regression  |
| 9 | **May 30** <br /> `Data analysis:` Frequent issues and solutions in mixed effects modeling; data wrangling; data workshop  | **Jun 1** <br />  `Project:` Final presentations |
